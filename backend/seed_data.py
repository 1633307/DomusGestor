...
def run():
    ...
    temporades_data = [
        ...
        (0, "Temporada Baixa",      "2000-01-01", "2000-03-31",  90.00, 2, []),
        (0, "Temporada Mitja",      "2000-04-01", "2000-06-30", 110.00, 3, []),
        (0, "Temporada Alta",       "2000-07-01", "2000-08-31", 155.00, 3, []),
        (0, "Temporada Mitja Tard", "2000-09-01", "2000-12-31", 105.00, 2, []),

        # 1 · Atic Vista Mar (base 220 €) — urbà Barcelona
        (1, "Temporada Baixa",      "2000-01-01", "2000-05-31", 180.00, 2, []),
        (1, "Temporada Alta",       "2000-06-01", "2000-09-15", 280.00, 3, []),
        (1, "Temporada Mitja",      "2000-09-16", "2000-12-31", 210.00, 2, []),

        # 2 · Casa amb jardi Sitges (base 350 €) — costa
        (2, "Hivern",               "2000-01-01", "2000-03-31", 270.00, 2, []),
        (2, "Primavera",            "2000-04-01", "2000-06-30", 340.00, 3, []),
        (2, "Estiu",                "2000-07-01", "2000-08-31", 480.00, 7, [5, 6]),
        (2, "Tardor",               "2000-09-01", "2000-12-31", 310.00, 3, []),

        # 3 · Estudi Barceloneta (base 75 €) — urbà costa
        (3, "Temporada Baixa",      "2000-01-01", "2000-06-14",  65.00, 2, []),
        (3, "Temporada Alta",       "2000-06-15", "2000-09-15",  95.00, 3, []),
        (3, "Temporada Baixa",      "2000-09-16", "2000-12-31",  65.00, 2, []),

        # 4 · Xalet Costa Brava (base 480 €) — costa gran
        (4, "Temporada Baixa",      "2000-01-01", "2000-03-31", 360.00, 2, []),
        (4, "Setmana Santa",        "2000-04-01", "2000-04-12", 520.00, 5, [5, 6]),
        (4, "Primavera/Tardor",     "2000-04-13", "2000-06-30", 420.00, 3, []),
        (4, "Temporada Alta",       "2000-07-01", "2000-08-31", 650.00, 7, [5, 6]),
        (4, "Tardor/Hivern",        "2000-09-01", "2000-12-31", 400.00, 3, []),

        # 5 · Pis Modern Eixample (base 150 €) — urbà Barcelona
        (5, "Temporada Baixa",      "2000-01-01", "2000-03-31", 120.00, 2, []),
        (5, "Temporada Mitja",      "2000-04-01", "2000-06-30", 150.00, 3, []),
        (5, "Temporada Alta",       "2000-07-01", "2000-08-31", 195.00, 3, []),
        (5, "Temporada Mitja Tard", "2000-09-01", "2000-12-31", 140.00, 2, []),

        # 6 · Apartament Girona Vella (base 95 €) — urbà
        (6, "Hivern",               "2000-01-01", "2000-05-31",  80.00, 2, []),
        (6, "Estiu",                "2000-06-01", "2000-09-30", 115.00, 3, []),
        (6, "Tardor/Hivern",        "2000-10-01", "2000-12-31",  80.00, 2, []),

        # 7 · Duplex Tarragona Mar (base 180 €) — costa
        (7, "Temporada Baixa",      "2000-01-01", "2000-05-31", 145.00, 2, []),
        (7, "Temporada Alta",       "2000-06-01", "2000-09-15", 230.00, 7, [5, 6]),
        (7, "Temporada Baixa",      "2000-09-16", "2000-12-31", 145.00, 2, []),

        # 8 · Casa Rural Osona (base 300 €) — rural
        (8, "Hivern",               "2000-01-01", "2000-03-31", 240.00, 2, []),
        (8, "Primavera",            "2000-04-01", "2000-06-30", 290.00, 3, [5]),
        (8, "Estiu",                "2000-07-01", "2000-08-31", 380.00, 7, [5, 6]),
        (8, "Tardor",               "2000-09-01", "2000-12-31", 260.00, 3, []),

        # 9 · Apartament Lleida Centre (base 70 €) — urbà
        (9, "Temporada Baixa",      "2000-01-01", "2000-06-30",  60.00, 2, []),
        (9, "Temporada Alta",       "2000-07-01", "2000-08-31",  85.00, 3, []),
        (9, "Temporada Baixa",      "2000-09-01", "2000-12-31",  60.00, 2, []),

        # 10 · Atic Terrassa Vista (base 130 €) — urbà
        (10, "Temporada Baixa",     "2000-01-01", "2000-05-31", 105.00, 2, []),
        (10, "Temporada Alta",      "2000-06-01", "2000-09-15", 165.00, 3, []),
        (10, "Temporada Baixa",     "2000-09-16", "2000-12-31", 105.00, 2, []),

        # 11 · Pis Badalona Platja (base 120 €) — costa urbana
        (11, "Temporada Baixa",     "2000-01-01", "2000-05-31",  95.00, 2, []),
        (11, "Temporada Alta",      "2000-06-01", "2000-09-15", 155.00, 7, [5, 6]),
        (11, "Temporada Mitja",     "2000-09-16", "2000-12-31", 110.00, 3, []),

        # 12 · Casa Adossada Sabadell — inactiva (base 160 €)
        (12, "Temporada Baixa",     "2000-01-01", "2000-06-30", 130.00, 2, []),
        (12, "Temporada Alta",      "2000-07-01", "2000-08-31", 190.00, 3, []),
        (12, "Temporada Baixa",     "2000-09-01", "2000-12-31", 130.00, 2, []),

        # 13 · Estudi Mataro Rambla (base 65 €) — costa
        (13, "Temporada Baixa",     "2000-01-01", "2000-06-14",  55.00, 2, []),
        (13, "Temporada Alta",      "2000-06-15", "2000-09-15",  80.00, 7, [5, 6]),
        (13, "Temporada Baixa",     "2000-09-16", "2000-12-31",  55.00, 2, []),

        # 14 · Apartament Manresa Nou (base 80 €) — urbà
        (14, "Temporada Única",     "2000-01-01", "2000-12-31",  80.00, 2, []),

        # 15 · Xalet Roses Costa (base 400 €) — costa gran
        (15, "Hivern",              "2000-01-01", "2000-03-31", 300.00, 2, []),
        (15, "Setmana Santa",       "2000-04-01", "2000-04-12", 450.00, 5, [5, 6]),
        (15, "Primavera",           "2000-04-13", "2000-06-30", 380.00, 3, []),
        (15, "Temporada Alta",      "2000-07-01", "2000-08-31", 560.00, 7, [5, 6]),
        (15, "Tardor/Hivern",       "2000-09-01", "2000-12-31", 350.00, 3, []),

        # 16 · Pis Figueres Rambla (base 85 €) — urbà
        (16, "Temporada Baixa",     "2000-01-01", "2000-06-30",  70.00, 2, []),
        (16, "Temporada Alta",      "2000-07-01", "2000-08-31", 105.00, 3, []),
        (16, "Temporada Baixa",     "2000-09-01", "2000-12-31",  70.00, 2, []),

        # 17 · Casa Rural Priorat (base 260 €) — rural
        (17, "Hivern",              "2000-01-01", "2000-03-31", 200.00, 2, []),
        (17, "Primavera/Tardor",    "2000-04-01", "2000-06-30", 250.00, 3, [5]),
        (17, "Estiu",               "2000-07-01", "2000-08-31", 330.00, 7, [5, 6]),
        (17, "Tardor",              "2000-09-01", "2000-12-31", 220.00, 3, []),

        # 18 · Apartament Tortosa Riu (base 75 €) — urbà
        (18, "Temporada Baixa",     "2000-01-01", "2000-06-30",  65.00, 2, []),
        (18, "Temporada Alta",      "2000-07-01", "2000-08-31",  90.00, 3, []),
        (18, "Temporada Baixa",     "2000-09-01", "2000-12-31",  65.00, 2, []),

        # 19 · Duplex Vilanova Centre (base 195 €) — costa
        (19, "Temporada Baixa",     "2000-01-01", "2000-05-31", 155.00, 2, []),
        (19, "Temporada Alta",      "2000-06-01", "2000-09-15", 245.00, 7, [5, 6]),
        (19, "Temporada Mitja",     "2000-09-16", "2000-12-31", 180.00, 3, []),
    ]
    ...
    temporades = [
        ...
        for idx, nom, inici, fi, preu, min_nits, dies_checkin in temporades_data
    ]
